    ...
    public ststusPage() {
        ...
        try {
            ...
            while (st.resultSet.next())
            {
                ...
                lblRentedAmount.setText( Math.round(rentedPercentage)  + "% of store is rented");
            ...
            while (st.resultSet.next())
            {
                ...
                lblFreeAmount.setText( Math.round(freePercentage)  + "% of store is free");
                pbFree.setMinimum(0);
            ...
            while (st.resultSet.next())
            {
                ...
                lblPaidAmount.setText( Math.round(paidPercentage)  + "% of rentees have paid");
                pbPaid.setMinimum(0);
            ...
            while (st.resultSet.next())
            {
                ...
                lblUnpaidAmount.setText( Math.round(unpaidPercentage)  + "% of rentees have unpaid");
